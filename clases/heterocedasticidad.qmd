...
1.  Regresar $y$ en las variables independientes. Obtener los residuos, los valores ajustados, los residuos al cuadrado y los valores ajustados al cuadrado.

2.  Regresar los residuos al cuadrado en los valores ajustados y los valores ajustados al cuadrado. Conservar el $R^2_{\hat{u}^2}$.
